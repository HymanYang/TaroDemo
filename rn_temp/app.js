...
import pagesDetailSecond from './pages/detail/second';
...
const RootStack = TaroRouter.initRouter([['pages/index/index', pagesIndexIndex], ['pages/detail/second', pagesDetailSecond]], Taro, App.config);
